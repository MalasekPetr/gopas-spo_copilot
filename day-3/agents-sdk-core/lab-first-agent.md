...
- Hotový lab z [`../onboarding/`](../../day-1/onboarding/lab-toolchain-scaffold.md) — scaffold
...
Máš-li scaffold z pondělí ([`../onboarding/lab-toolchain-scaffold.md`](../../day-1/onboarding/lab-toolchain-scaffold.md)),
...
přeroste (akce v [`../actions-graph/`](../../day-4/actions-graph/)), vytáhneš business logiku
...
víc ne, ladit se bude v [`../prompt-orchestration/`](../../day-4/prompt-orchestration/):
