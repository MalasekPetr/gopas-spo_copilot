...
> Typ: povinný · Den: 5 · Odhad: **60 min** — instruktorské demo (osa hostingu → samostudium) · Publikum: **vývojáři / architekti**
...
- **Manifest se musí shodovat s tím, co agent skutečně dělá.** Akce přidané v modulu
  [`../../day-2/actions-graph/`](../../day-2/actions-graph/) (`CreateTicket`, čtení
...
- Praktické pravidlo: **verze manifestu a verze nasazeného buildu patří do jedné release
  ...
  [`../../day-5/perf-cost-lifecycle/`](../../day-5/perf-cost-lifecycle/).
