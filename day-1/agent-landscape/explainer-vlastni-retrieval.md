...
Otevři na plátně jejich vlastní `retrieve()` z [`../../knowledge-grounding/solution/agent.ts`](../../day-3/knowledge-grounding/solution/agent.ts)
...
| | [`solution/agent.ts`](../../day-3/knowledge-grounding/solution/agent.ts) | [`solution/agent-retrieval-api.ts`](../../day-3/knowledge-grounding/solution/agent-retrieval-api.ts) |
|---|---|---|
...
> Podrobně i se zdroji: [`../../perf-cost-lifecycle/mereni-retrieval-vs-search.md`](../../day-5/perf-cost-lifecycle/mereni-retrieval-vs-search.md).

> [!TIP] Naměřené srovnání obou cest
> [`../../perf-cost-lifecycle/mereni-retrieval-vs-search.md`](../../day-5/perf-cost-lifecycle/mereni-retrieval-vs-search.md)
...
Plný text k samostudiu: [`../../opt-custom-retrieval/`](../../day-3/opt-custom-retrieval/) —
...
> U varianty s **Copilot Retrieval API** ([`agent-retrieval-api.ts`](../../day-3/knowledge-grounding/solution/agent-retrieval-api.ts))
