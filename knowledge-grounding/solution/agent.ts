// ============================================================================
// VYSTUPNI STAV PO LABU: knowledge-grounding (konec dne 3)
//
// Agent vola model s chybovymi vetvemi, odpovida z runbooku s citacemi
// (MOCK i ZIVE pres Graph Search) a vede ucetni knihu spotreby.
//
// Startovni cara pro: actions-graph (den 4, blok 1)
// Predchozi stav:     ../../agents-sdk-core/solution/agent.ts
// ============================================================================
