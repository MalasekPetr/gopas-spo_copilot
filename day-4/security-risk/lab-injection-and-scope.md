...
- Agent z [`../../evaluation-quality/`](../../day-5/evaluation-quality/lab-golden-set.md)
...
8. **Odděl identitu triage a resolver agenta** z [`../../agent-framework/`](../../day-5/agent-framework/).
...
12. Přidej útočné případy do **golden setu** z [`../evaluation-quality/`](../../day-5/evaluation-quality/lab-golden-set.md)
...
13. Ověř v **telemetrii** z [`../../agent-365-governance/`](../../day-5/agent-365-governance/),
