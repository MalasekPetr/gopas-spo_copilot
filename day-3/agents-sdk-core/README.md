...
verze toho dnešního — je to [vrstvená mapa, ne žebřík](../../day-1/agent-landscape/README.md).
...
| **Autorizace a ACL trimming** | zdarma ze zdroje, agent nikdy nepřekročí práva uživatele | **tvůj kód**, per akce — [`../../actions-graph/`](../../day-4/actions-graph/) |
| **Grounding** | capability v manifestu | tvoje volání — Retrieval API, konektor nebo vlastní index |
| **Audit a governance** | platforma | tvoje instrumentace — [`../../agent-365-governance/`](../../day-5/agent-365-governance/) |
| **Lifecycle** | verze manifestu | build, deploy, rollback — [`../../event-driven-hosting/`](../../day-5/event-driven-hosting/) |
...
- **Peněženky se nemění na jednu, ale na čtyři.** Copilot Credits nezmizí — grounding přes
  ...
  s čísly v [`../../perf-cost-lifecycle/`](../../day-5/perf-cost-lifecycle/).
...
- **Agents SDK** (transport, stav, routing) vs. **orchestrace** (kdo rozhoduje, co agent řekne)
  — orchestrace přijde v [`../../agent-framework/`](../../day-5/agent-framework/).
