...
node <klon-repa>/day-4/actions-graph/solution/device-auth.mjs "offline_access User.Read Files.Read.All Sites.Read.All Sites.ReadWrite.All" | Out-File .lab-token -Encoding ascii -NoNewline
...
v [`../prompt-orchestration/`](../../day-4/prompt-orchestration/).
