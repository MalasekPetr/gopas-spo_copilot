...
> Typ: **volitelný / samostudium** · Den: 4 (jen při náskoku) · Odhad: **40 min** (15 výklad + 25 lab) · Publikum: **vývojáři / architekti**
...
- **Copilot Apps nejsou další druh agenta.** Na rozhodovací ose z
  [`../../agent-landscape/`](../../day-1/agent-landscape/) pro ně není příčka —
...
- **MCP nit kurzu tady vrcholí**: federated konektory přes MCP
  ([`../../knowledge-grounding/`](../../day-3/knowledge-grounding/)) → MCP nástroj
