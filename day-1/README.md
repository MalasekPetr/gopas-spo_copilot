...
|---|---|---|---|---|
| — | Základy promptování a agentní anatomie | [`opt-prompting-fundamentals`](opt-prompting-fundamentals/) | **V** | 35 min čtení |
...
- [`opt-prompting-fundamentals`](./opt-prompting-fundamentals/) — anatomie promptu,
  ...
  [`../declarative-agents/`](../day-2/declarative-agents/), kde se píší Agent Instructions.
