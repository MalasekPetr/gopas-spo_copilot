...
a jako s **cestou k nástrojům** ([`../actions-graph/`](../../day-4/actions-graph/)). Tenhle
...
Tool-call smyčka z [`../actions-graph/`](../../day-4/actions-graph/lab-actions-and-graph.md)
...
dodává instrukce do promptu (XPIA vektor, [`../middleware-policy/`](../../day-4/middleware-policy/));
...
| **MCP Apps → SharePoint Copilot Apps** | rozšíření MCP o interaktivní UX; v M365 jako SPFx ([`../spfx-copilot-apps/`](../../day-4/spfx-copilot-apps/)) |

## Kdy MCP a kdy ne

Rozhodovací tabulka je v [`../actions-graph/README.md`](../../day-4/actions-graph/README.md)
