...
- Detail governance a instrumentace: [`../../agent-365-governance/`](../../day-5/agent-365-governance/).
...
- Mechanika protokolu (role, primitiva, transport — a jak MCP zapadá do tool-call
  smyčky z labu): [`../knowledge-grounding/explainer-mcp.md`](../../day-3/knowledge-grounding/explainer-mcp.md).
