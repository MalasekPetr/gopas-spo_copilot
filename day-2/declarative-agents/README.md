...
[`../../opt-prompting-fundamentals/`](../../day-1/opt-prompting-fundamentals/).
...
> [`../../marketplace-agents/`](../marketplace-agents/) (materiál
...
- Deklarativní agent z Toolkitu **není** Copilot Studio agent — jiné ALM, jiná peněženka,
  jiný nástroj (viz [`../../no-code-showcase/`](../../day-1/no-code-showcase/)).
