...
## Referenční řešení labu

Odpovědi ke všem třem zadáním, včetně toho, co konkrétně nefunguje u zavržené cesty:
[`reseni-lab-decision-matrix.md`](reseni-lab-decision-matrix.md). **Promítat až po části C** —
hodnota labu je v obhajobě, ne v uhodnutí.
...
- Dopředu: osa se materializuje hned v `no-code-showcase` (agent builder + Copilot Studio
  ...
  `agents-sdk-core` (ráno D3);
  governance vrstva mapy se otevře v `agent-365-governance` (D5).
