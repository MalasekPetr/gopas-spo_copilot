...
kreslí jako přechod hranice ([capstone, část A](../capstone/lab-capstone-blueprint.md)).
...
> žijí v [`../../perf-cost-lifecycle/prices-snapshot.json`](../perf-cost-lifecycle/prices-snapshot.json)
> (`--refresh-prices`).
