...
|---|---|---|---|---|
| 0 | **Rekapitulace rozhodovací mapy** — otvírák | [`agent-landscape`](../agent-landscape/recap-d5-rozhodovaci-mapa.md) | P | 20 |
...
> ([`den-2.md`](den-2.md)). Při třetí rekalibraci demo padlo. Otázka ale nezmizela:
...
> [`../opt-custom-retrieval/`](../opt-custom-retrieval/) k samostudiu.
