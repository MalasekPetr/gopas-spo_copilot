...
- Přímý důsledek: **každé rozšíření knowledge nebo capabilities je rozšíření útočné
  ...
  [`../../declarative-agents/`](../../day-2/declarative-agents/) — tehdy jako pravidlo,
...
- **Pipeline musí obalit každý turn, ne jen finální odpověď.** Dnešní agent má jednu
  ...
  kterému nesmíš věřit. Až přibude druhý agent ([`../agent-framework/`](../../day-5/agent-framework/),
...
- Middleware je testovatelný **bez modelu**: vstup dovnitř, verdikt ven. Tím se z obrany
  stává regresní test — vstup do [`../../evaluation-quality/`](../../day-5/evaluation-quality/).
...
5. **Oddělené identity pro agenty** (Microsoft Entra Agent ID). Triage a resolver nemusí mít
   ...
   [`../../agent-365-governance/`](../../day-5/agent-365-governance/).
...
nad pipeline bez volání modelu) — naváže [`../../evaluation-quality/`](../../day-5/evaluation-quality/).
...
z [`../agent-framework/`](../../day-5/agent-framework/): dotaz 4 ze
