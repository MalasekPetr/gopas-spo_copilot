...
> Vznikl spojením `middleware-policy` a `security-risk` ([`../../day-5/security-risk/`](../../day-5/security-risk/)).
...
- Přímý důsledek: **každé rozšíření knowledge nebo capabilities je rozšíření útočné
  ...
  [`../../day-2/declarative-agents/`](../../day-2/declarative-agents/) — tehdy jako pravidlo,
...
- Middleware je testovatelný **bez modelu**: vstup dovnitř, verdikt ven. Tím se z obrany
  stává regresní test — vstup do [`../../day-5/evaluation-quality/`](../../day-5/evaluation-quality/).
...
1. **Delegated místo app-only.** Agent dědí oprávnění uživatele — co uživatel nevidí,
   ...
   (protipříklad z [`../../day-2/actions-graph/`](../../day-2/actions-graph/), část D labu).
...
nad pipeline bez volání modelu) — naváže [`../../day-5/evaluation-quality/`](../../day-5/evaluation-quality/).
