...
- Agent z [`../../evaluation-quality/`](../evaluation-quality/lab-golden-set.md)
...
8. **Odděl identitu triage a resolver agenta** z [`../../agent-framework/`](../agent-framework/).
...
13. Ověř v **telemetrii** z [`../../agent-365-governance/`](../agent-365-governance/),
